...
class InstructionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instruction" do
    assert_difference('Instruction.count') do
      post instructions_url, params: { instruction: { description: @instruction.description, guidance_id: @instruction.guidance_id, image: @instruction.image } }
    end
  ...
  test "should update instruction" do
    patch instruction_url(@instruction), params: { instruction: { description: @instruction.description, guidance_id: @instruction.guidance_id, image: @instruction.image } }
